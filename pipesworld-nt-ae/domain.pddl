...
(define (domain pipesworld-notankage-ae)
  ...
  (:predicates
   ...
   ;; to control splitting process (push/pop update)
   ;; note: in push-/pop-updating, ?pos is the last updated
   ;; position and ?batch is the type of the floating batch.
   (normal ?pipe - pipe)
